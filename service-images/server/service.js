...
module.exports = (config) => {
  ...
  service.put('/addVideoToPatientById/:id', (req, res, next) => {
    try {
      // body validater
  ...
  service.put('/addImagesToPatientById/:id', cors(corsOptions), uploader.array('images'), (req, res, next) => {
    try {
      const { id } = req.params
      ...
      */
      ...
      const promises = req.files.map((file, index) => {
        ...
        return new Promise((resolve, reject) => {
          ...
          const newFileName = id + '-image-' + Date.now() + '.' + mime.getExtension(file.mimetype)
  ...
  service.get('/getImagesOfPatientById/:id', (req, res, next) => {
    try {
      const { id } = req.params
  ...
  service.get('/getVideosOfPatientById/:id', (req, res, next) => {
    try {
      const { id } = req.params
